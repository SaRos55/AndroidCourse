...
fun Cursor.toPost() = Post(
    ...
    likedCount = getInt(getColumnIndexOrThrow(PostsTable.Column.LIKES.columnName)),
    likedByMe = getInt(getColumnIndexOrThrow(PostsTable.Column.LIKED_BY_ME.columnName)) != 0,
    sharedCount = getInt(getColumnIndexOrThrow(PostsTable.Column.SHARES.columnName))
    )